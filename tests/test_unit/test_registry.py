...
Covers registration, capability flags on the built-in adapters, longest-prefix detection routing to a registered third-
party adapter, lazy entry-point discovery (via a monkeypatched group), and backwards-compatible ``isinstance``.
