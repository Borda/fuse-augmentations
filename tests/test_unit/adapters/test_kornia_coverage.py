...
_rotation90_cls = (
    next((cls for cls in TRANSFORM_REGISTRY if cls.__name__ == "RandomRotation90"), None) if _KORNIA_AVAILABLE else None
)
...
class TestRegistryCoverage:
    ...
    @pytest.mark.skipif(_rotation90_cls is None, reason="RandomRotation90 not available in installed kornia version")
    def test_random_rotation90_sample_params_include_k90(self, adapter):
        ...
        instance = _make_instance(_rotation90_cls)
