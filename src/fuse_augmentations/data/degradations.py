...
into an on-disk dataset** by :func:`~fuse_augmentations.data.generate_dataset` — a fixed property of
...
class GaussianNoise(Degradation):
    ...
    Examples:
        ```pycon
        >>> import numpy as np
        >>> from fuse_augmentations.data.degradations import GaussianNoise
...
class GaussianBlur(Degradation):
    ...
    Examples:
        ```pycon
        >>> import numpy as np
        >>> from fuse_augmentations.data.degradations import GaussianBlur
...
class JPEG(Degradation):
    ...
    Examples:
        ```pycon
        >>> import numpy as np
        >>> from fuse_augmentations.data.degradations import JPEG
...
class Contrast(Degradation):
    ...
    Under :attr:`~fuse_augmentations.data.config.ClassMode.COLOR` this is the knob that makes classes
...
class ColorCast(Degradation):
    ...
    Examples:
        ```pycon
        >>> import numpy as np
        >>> from fuse_augmentations.data.degradations import ColorCast
...
class Vignette(Degradation):
    ...
    Examples:
        ```pycon
        >>> import numpy as np
        >>> from fuse_augmentations.data.degradations import Vignette
...
class Quantize(Degradation):
    ...
    Examples:
        ```pycon
        >>> import numpy as np
        >>> from fuse_augmentations.data.degradations import Quantize
