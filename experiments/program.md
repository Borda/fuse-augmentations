...
`optimize_score.py --repetitions 1` uses 20 warmups plus 10 timed batches of 10 calls for each of the 45 cases and must stay within the 120 s `VERIFY_TIMEOUT_SEC` limit. The script defaults to three complete measurements elsewhere.
